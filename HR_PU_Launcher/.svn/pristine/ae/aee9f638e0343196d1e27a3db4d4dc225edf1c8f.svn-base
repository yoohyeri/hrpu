...
public class ScreenSaver_AnalogClock extends View {
	public ScreenSaver_AnalogClock(Context context) {
		this(context, null);
	}
	...
	public ScreenSaver_AnalogClock(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ScreenSaver_AnalogClock(Context context, AttributeSet attrs, int defStyle) {
		...
		if (this.mDial == null) {
			if (HP_Manager.Vendor.equals(HP_Manager.SYSTEM_VENDOR_HYUNDAI))
				this.mDial = r.getDrawable(R.drawable._analog_bg);
			else
				this.mDial = r.getDrawable(R.drawable.kia_analog_bg);
		}
		if (this.mHourHand == null) {
			if (HP_Manager.Vendor.equals(HP_Manager.SYSTEM_VENDOR_HYUNDAI))
				this.mHourHand = r.getDrawable(R.drawable.analog_hour_1);
			else
				this.mHourHand = r.getDrawable(R.drawable.kia_analog_hour_1);
		}
		if (this.mMinuteHand == null) {
			if (HP_Manager.Vendor.equals(HP_Manager.SYSTEM_VENDOR_HYUNDAI))
				this.mMinuteHand = r.getDrawable(R.drawable.analog_min_1);
			else
				this.mMinuteHand = r.getDrawable(R.drawable.kia_analog_min_1);
		}
		mCalendar = new Time();
	...
	public class MyCount extends CountDownTimer {
		...
		public void onTick(long millisUntilFinished) {
			...
			mSecond = 6.0f * second;
			mSeconds = true;
			ScreenSaver_AnalogClock.this.invalidate();
		}
	}
