...
{
	private static final String CLASS_NAME = "[DxbDB_Setting ]  ";
	...
	public void loadSettings(SQLiteDatabase db)
	{
		...
		cv.put(KEY_PRESET, DMB_Manager.DEFAULT_VALUE_PRESET);
		cv.put(KEY_AREA, DMB_Manager.DEFAULT_VALUE_AREA_CODE);
		cv.put(KEY_AGE, DMB_Manager.DEFAULT_VALUE_PARENTAL_RATING);
	...
	public int getPreset()
	{
		...
		if (cursor == null || cursor.getCount() <= 0)
		{
			...
			return DMB_Manager.DEFAULT_VALUE_PRESET;
		}
	...
	public int getArea()
	{
		...
		if (cursor == null || cursor.getCount() <= 0)
		{
			...
			return DMB_Manager.DEFAULT_VALUE_AREA_CODE;
		}
