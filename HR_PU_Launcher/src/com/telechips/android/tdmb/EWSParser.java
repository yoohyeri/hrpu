...
public class EWSParser {
	...
	public EWSParser() {
		ews_type = new String[][]
		{
			...
			{"ALW", "\uACBD\uACC4\u0020\uACBD\uBCF4"},                                            // ALert Warning                                      "경계 경보"
			{"ARW", "\uACF5\uC2B5\u0020\uACBD\uBCF4"},                                             // Air-Raid Warning                                  "공습 경보"
			{"CRW", "\uD654\uC0DD\uBC29\u0020\uACBD\uBCF4"},                                 // Chemical-biological & Radiological Warning  "화생방 경보"
			{"DIA", "\uC7AC\uB09C\uACBD\uACC4\u0020\uACBD\uBCF4"},                      // DIsaster wAtch                                     "재난경계 경보"
			{"DIW", "\uC7AC\uB09C\uC704\uD5D8\u0020\uACBD\uBCF4"},                      // DIsaster Warning                                   "재난위험 경보"
			{"DWC", "\uACBD\uBCF4\u0020\uD574\uC81C"},                                           // Disaster Warning Clear                            "경보 해제"
			{"MFA", "\uC0B0\uBD88\u0020\uC8FC\uC758\uBCF4"},                                   // Mountain Fire wAtch                                "산불 주의보"
			{"YSA", "\uD669\uC0AC\u0020\uC8FC\uC758\uBCF4"},                                  // Yellow Sand wAtch                                  "황사 주의보"
			{"RAA", "\uBC29\uC0AC\uB2A5\uACBD\uACC4\u0020\uACBD\uBCF4"},          // RAdioactivity wAtch                                 "방사능경계 경보"
			{"RAW", "\uBC29\uC0AC\uB2A5\u0020\uC8FC\uC758\uBCF4"},                      // RAdioactivity Warning                               "방사능 주의보"
		};
    ...
    public int priority;               // 경보 우선 순위
    public int time;                    // 재난 발령 시간
    public int local_type;             // 재난 지역 형식
    public int local_count;            // 재난 지역 수
